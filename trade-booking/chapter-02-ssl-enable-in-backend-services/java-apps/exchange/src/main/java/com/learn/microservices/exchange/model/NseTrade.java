package com.learn.microservices.exchange.model;
...
public class NseTrade {
    ...
    public NseTrade(String exchange, LocalDate tradeDate, LocalTime tradeTime, String symbol,
                    String tradeId, String orderId, String exchangeOrderId, String buySell,
                    int quantity, BigDecimal price, BigDecimal tradeValue,
                    String clientCode, String brokerCode, LocalDateTime timestampExchange, String moneyManagerCode) {
